...
export default function RegisterForm({role ="USER"}) {
  ...
  async function onSubmit(data) {
    try {
      ...
      if (response.ok) {
        ...
        //router.push("/onboarding/65785476fc1c947b3051789c");
        if (role === "USER"){
          router.push("/");
        } else {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="">
      ...
      <TextInput label="Full Name" name="name" register={register} errors={errors} type="text" className="sm:col-span-2 mb-3" />
      ...
      <SubmitButton isLoading={loading} buttonTitle="Register" loadingButtonTitle="Creating User Please wait" />
